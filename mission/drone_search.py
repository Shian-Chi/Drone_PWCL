                    ...
                    for row in range(len(drone_point)):
                        if row == 0:
                            ...
                            if droneSub.yolo_detect_status == True:
                                print("land test1")
                                fly_to_global_without_detect(dronePub, droneSub, origin_latitude, origin_longitude, drone_point[row][1], 0.0)
                            ...
                            print("new point")
                            print(row)
                            fly_to_global(dronePub, droneSub, droneCli, drone_point[row][2], drone_point[row][3], drone_point[row][1], drone_point[row][4], origin_latitude, origin_longitude)
                            if droneSub.yolo_detect_status == True:
                                print("land test2")
                                fly_to_global_without_detect(dronePub, droneSub, origin_latitude, origin_longitude, drone_point[row][1], 0.0)
                                droneCli.requestLand()
