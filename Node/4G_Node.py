...
# ipaddr = '10.242.75.0' # LHU laptop's vpn address
# ipaddr = '192.168.0.75' # Wi-Fi address 
ipaddr = '10.147.20.230' # Mobile device's vpn address
port = 80
drone_id = bytes('\x01', 'utf-8') #drone_id
